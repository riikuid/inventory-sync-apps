...
class CreateComponentInBoxScreen extends StatefulWidget {
  final VariantDetailRow variantDetailRow;

  const CreateComponentInBoxScreen({super.key, required this.variantDetailRow});

  @override
  State<CreateComponentInBoxScreen> createState() =>
      _CreateComponentInBoxScreenState();
}

class _CreateComponentInBoxScreenState
    extends State<CreateComponentInBoxScreen> {
